...
public class InputData {
    ...
    private BigDecimal amount = BigDecimal.valueOf(180);
    private BigDecimal monthsDuration = BigDecimal.valueOf(180);
    private RateType rateType = RateType.CONSTANT;
    private BigDecimal bankingMarginPercent = BigDecimal.valueOf(1.9);
    ...
    public InputData withBankingMarginPercent(BigDecimal bankingMarginPercent) {
        this.bankingMarginPercent = bankingMarginPercent;
        return this;
    }
    ...
    public BigDecimal getInterestPercent() {
        return wiborPercent.add(bankingMarginPercent).divide(PERCENT, 4, RoundingMode.HALF_UP);
    }

    public BigDecimal getInterestDisplay() {
        return wiborPercent.add(bankingMarginPercent).setScale(2,RoundingMode.HALF_UP);
    }
